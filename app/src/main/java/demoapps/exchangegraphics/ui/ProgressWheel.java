package demoapps.exchangegraphics.ui;
...
import demoapps.exchangegraphics.R;
 ...
 *
 * @author Nico Hormazábal <p> Licensed under the Apache License 2.0 license see:
...
public class ProgressWheel extends View {
    ...
    private void setupBounds(int layout_width, int layout_height) {
        ...
        if (!fillRadius) {
            // Width should equal to Height, find the min value_in to setup the circle
    ...
    /**
     * Set the progress to a specific value_in, the bar will be set instantly to that value_in
     *
    ...
    /**
     * Set the progress to a specific value_in, the bar will smoothly animate until that value_in
     *
     * @param progress the progress between 0 and 1
     */
     ...
     * one second), this value_in also is applied for the smoothness when setting a progress
     */
     ...
     * second), this value_in also is applied for the smoothness when setting a progress
     *
